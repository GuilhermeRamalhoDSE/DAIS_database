angular.module('frontend').factory('AuthService', ['$http', '$window', function($http, $window) {
    ...
    authService.login = function(credentials) {
        return $http.post('http://127.0.0.1:8080/api/login/', credentials).then(function(response) {
    ...
    authService.fetchAndStoreModules = function(licenseId) {
        ...
        return $http.get('http://127.0.0.1:8080/api/licenses/' + licenseId + '/modules/').then(function(response) {
    ...
    authService.isModuleInAnyGroup = function(moduleSlug, groupId) {
        ...
        return $http.get(`http://127.0.0.1:8080/api/groups/${groupId}/modules/`)
