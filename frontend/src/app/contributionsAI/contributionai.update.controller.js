angular.module('frontend').controller('ContributionAIUpdateController', ['$scope', 'ContributionAIService', 'LicenseService', 'AuthService', '$state', '$stateParams', 'Upload', '$q', '$interval', function($scope, ContributionAIService, LicenseService, AuthService, $state, $stateParams, Upload, $q, $interval) {
