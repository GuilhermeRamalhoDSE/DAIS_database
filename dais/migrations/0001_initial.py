    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('typology', models.CharField(choices=[('Artificial Intelligence', 'Artificial Intelligence'), ('Digital Signage', 'Digital Signage')], max_length=24)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dais.campaignai')),
            ],
        ),
        migrations.CreateModel(
            name='ContributionAI',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dais.campaignds')),
            ],
        ),
        migrations.CreateModel(
            name='ContributionDS',
